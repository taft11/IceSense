...
// Product Catalog
const PRODUCTS = [
  { id: 'tube-5', name: '5kg Tube Ice', price: 25, image: '/images/tube-5kg.png', desc: 'Perfect for small coolers and home parties.' },
  { id: 'tube-35', name: '35kg Tube Ice', price: 120, image: '/images/tube-35kg.png', desc: 'Ideal for medium-sized events and small businesses.' },
  { id: 'tube-50', name: '50kg Tube Ice', price: 150, image: '/images/tube-50kg.png', desc: 'Wholesale size for restaurants and large scale cooling.' },
  { id: 'crushed-crate', name: 'Crates Crushed Ice', price: 180, image: '/images/crushed-crate.png', desc: 'Premium crushed ice delivered in hygienic crates.' },
  { id: 'crushed-sack', name: 'Crushed Ice on Sack', price: 140, image: '/images/crushed-sack.png', desc: 'Bulk crushed ice packed securely in sacks.' },
];
...
export default function CustomerPortal() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 font-sans">
      {/* Sidebar */}
      <aside className="w-64 bg-white border-r border-gray-200 shadow-sm p-6 hidden md:flex flex-col sticky top-0 h-screen">
        ...
        <nav className="flex-1">
          <ul className="space-y-4">
            <li>
              <Link to="/order" className="flex items-center text-[#4091c9] font-bold bg-blue-50 p-3 rounded-lg">
                <ShoppingCart className="mr-3 h-5 w-5" /> Order Ice
              </Link>
            </li>
            <li>
              <a href="#" className="flex items-center text-gray-600 hover:text-[#4091c9] p-3 rounded-lg transition-colors">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {PRODUCTS.map((product) => (
                ...
                >
                  {/* Image Placeholder */}
                  <div className="w-24 h-24 mb-3 rounded-lg bg-gray-50 flex items-center justify-center p-2">
                    <img 
                      src={product.image} 
                      alt={product.name}
