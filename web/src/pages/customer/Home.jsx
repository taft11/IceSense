...
import { ArrowRight, Smartphone, Truck, ShieldCheck, Droplet, MapPin } from 'lucide-react';
      ...
      <div className="relative min-h-[90vh] flex items-center overflow-hidden">
         ...
         <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-24 flex flex-col items-start w-full mt-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
               <Link to="/login" className="bg-[#4091c9] hover:bg-[#2d75aa] text-white font-bold py-4 px-8 rounded-full text-lg transition duration-300 flex items-center justify-center shadow-xl">
      ...
      <footer className="bg-gray-900 text-gray-400 py-16 text-sm">
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12 border-b border-gray-800 pb-12">
            ...
            <div>
               ...
               <ul className="space-y-3 text-base">
                  <li><Link to="/login" className="hover:text-[#4091c9] transition">Customer Portal</Link></li>
